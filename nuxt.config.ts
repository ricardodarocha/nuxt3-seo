    ...
    app: {
        head: {
            ...
            meta: [
                ...
                { hid: 'og-url', property: 'og:url', content: 'https://ricardodarocha.com.br?from=meta' }, 
                ...
                { hid: 't-type', property: 'twitter:title', content: 'Picolé do Gilmar' },                 
